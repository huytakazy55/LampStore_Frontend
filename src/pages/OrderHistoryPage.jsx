...
const OrderHistoryPage = () =>
{
                                            ...
                                            <div className='px-3 py-3 flex items-center gap-3'>
                                                ...
                                                <div className='min-w-0'>
                                                    <p className='text-sm font-medium text-gray-800 dark:text-gray-200 line-clamp-1 cursor-pointer hover:text-primary-600 transition-colors'
                                                        onClick={() => { setSelectedOrder(null); if (item.productId) navigate(`/product/${item.productId}`); }}>
                                                        {item.productName}
                                                    </p>
                                                    {optionText && (
    ...
    return (
        <>
            <Helmet>
                <title>Đơn hàng của tôi | CapyLumine</title>
            ...
            <main className='w-full mb-8 xl:mx-auto xl:max-w-[1440px] px-4 xl:px-0 min-h-[60vh]'>
                ...
                {loading && (
                    <div className='flex flex-col items-center justify-center py-20'>
                        <div className="animate-spin rounded-full h-10 w-10 border-2 border-primary-200 border-t-primary-600 mb-4"></div>
                        ...
                        {filteredOrders.map((order) =>
                        {
                            ...
                            return (
                                <div key={order.id}
                                    ...
                                    {/* Product Preview - show first 2 items */}
