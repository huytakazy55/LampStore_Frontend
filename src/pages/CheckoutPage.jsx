                ...
                <div className='min-h-screen bg-gray-50 pt-8 pb-16'>
                    <div className='max-w-2xl mx-auto px-4'>
                        <div className='bg-white rounded-lg shadow-sm p-8 text-center'>
                            ...
                            <p className='text-gray-500 mb-6'>Cảm ơn bạn đã mua hàng tại LampStore</p>
            ...
            <div className='min-h-screen bg-gray-50 pt-6 pb-16'>
                <div className='max-w-6xl mx-auto px-4'>
                    ...
                    <div className='flex items-center gap-2 text-sm text-gray-500 mb-6'>
                        <span className='cursor-pointer hover:text-rose-600 transition-colors' onClick={() => navigate('/')}>Trang chủ</span>
                        <i className='bx bx-chevron-right'></i>
                        <span className='cursor-pointer hover:text-rose-600 transition-colors' onClick={() => navigate(-1)}>Giỏ hàng</span>
                        <i className='bx bx-chevron-right'></i>
                            ...
                            <div className='lg:col-span-1'>
                                <div className='bg-white rounded-lg shadow-sm p-6 sticky top-6'>
                                    ...
                                    <p className='text-xs text-center text-gray-400 mt-3'>
                                        Bằng việc đặt hàng, bạn đồng ý với điều khoản sử dụng của LampStore
                                    </p>
                                </div>
                            </div>
                        </div>
