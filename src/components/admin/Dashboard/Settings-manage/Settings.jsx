...
const Settings = () => {
  ...
  const handleVolumeChange = (value) => {
    ...
    NotificationService.setAudioVolume(volume);
            ...
            <Row gutter={[24, 24]}>
              <Col span={24}>
                <Card
                  title={
                    <span>
                      <SoundOutlined style={{ marginRight: 8, color: themeColors.StartColorLinear }} />
                  ...
                  <Row gutter={[24, 16]}>
                    <Col span={12}>
                      ...
                      <div style={{ marginBottom: 16 }}>
                        ...
                        <Select
                          value={audioSettings.notificationType}
                          onChange={(value) => setAudioSettings(prev => ({ ...prev, notificationType: value }))}
                          style={{ width: '100%' }}
                        >
                ...
                <Card
                  title={
                    <span>
                      <NotificationOutlined style={{ marginRight: 8, color: themeColors.StartColorLinear }} />
                ...
                <Card
                  title={
                    <span>
                      <ExperimentOutlined style={{ marginRight: 8, color: themeColors.StartColorLinear }} />
                      Debug kết nối SignalR
                    </span>
                  }
                >
                  <div style={{ marginBottom: 16 }}>
                    <p style={{ marginBottom: 12 }}>
                      Sử dụng các công cụ dưới đây nếu không nhận được thông báo real-time:
                    </p>
                    ...
                    <div style={{ display: 'flex', gap: 12, marginBottom: 12 }}>
                      <Button
                        ...
                        onClick={() => {
                          ...
                          message.info(`Kiểm tra console để xem chi tiết. Connected: ${debugInfo.signalRInitialized && debugInfo.chatServiceConnected}`);
                        }}
                      >
                        Kiểm tra trạng thái
                      </Button>
                      ...
                      <Button
                        ...
                        onClick={async () => {
                          try {
                            message.loading('Đang kết nối lại...', 2);
                            ...
                            message.error('Lỗi khi kết nối lại');
                          }
                        }}
                      >
                        Kết nối lại SignalR
                ...
                <Card title="Sao lưu dữ liệu" style={{ marginBottom: 16 }}>
                  <div style={{ marginBottom: 16 }}>
                    ...
                    <Switch
                      ...
                      onChange={(value) => handleSystemSettingChange('autoBackup', value)}
                      checkedChildren="Bật"
                      unCheckedChildren="Tắt"
                    />
                  </div>
                  ...
                  <div style={{ marginBottom: 16 }}>
                    ...
                    <Select
                      ...
                      onChange={(value) => handleSystemSettingChange('backupFrequency', value)}
                      style={{ width: '100%' }}
                ...
                <Card title="Logging">
                  <div style={{ marginBottom: 16 }}>
                    ...
                    <Select
                      ...
                      onChange={(value) => handleSystemSettingChange('logLevel', value)}
                      style={{ width: '100%' }}
                    >
              ...
              <Col span={12}>
                <Card title="Hiển thị dữ liệu" style={{ marginBottom: 16 }}>
                  <div style={{ marginBottom: 16 }}>
                    ...
                    <Select
                      value={userSettings.defaultPageSize}
                      onChange={(value) => handleUserSettingChange('defaultPageSize', value)}
                      style={{ width: '100%' }}
                    >
                  ...
                  <div style={{ marginBottom: 16 }}>
                    ...
                    <Select
                      ...
                      onChange={(value) => handleUserSettingChange('dateFormat', value)}
                      style={{ width: '100%' }}
                    >
                  ...
                  <div style={{ marginBottom: 16 }}>
                    ...
                    <Select
                      ...
                      onChange={(value) => handleUserSettingChange('timeFormat', value)}
                      style={{ width: '100%' }}
                    >
