        ...
        <div className='w-full h-16 bg-white flex justify-between items-center px-8 border-b border-gray-300'>
            ...
            <div className='flex justify-center items-center gap-8'>
                <div ref={buttonColorRef} onClick={toggleShowColor} className='w-12 h-5 rounded-[10%] cursor-pointer relative'>
                    <div style={{background: `linear-gradient(0deg, ${themeColors.StartColorLinear} 0%, ${themeColors.EndColorLinear} 100%)`}} className='w-full h-full rounded-[10%]'></div>
                        <div ref={colorRef} style={{background: `linear-gradient(0deg, ${themeColors.StartColorLinear} 0%, ${themeColors.EndColorLinear} 100%)`}} className={`absolute top-7 right-1 w-52 py-4 px-5 rounded-tl-2xl rounded-bl-2xl rounded-br-2xl z-[1000] ${showColor ? 'block' : 'hidden'}`}>
                            <div className='flex justify-start gap-4 items-center font-medium py-1 px-3 rounded-md text-white hover:bg-fuchsia-700/25' onClick={() => changeTheme({StartColorLinear: 'rgba(136,70,249,1)', EndColorLinear: 'rgba(255,175,0,1)'})}>
                            ...
                            <div className='flex justify-start gap-4 items-center font-medium py-1 px-3 rounded-md text-white hover:bg-fuchsia-700/25' onClick={() => changeTheme({StartColorLinear: 'rgba(100,90,255,1)', EndColorLinear: 'rgba(255,100,100,1)'})}>
                            ...
                            <div className='flex justify-start gap-4 items-center font-medium py-1 px-3 rounded-md text-white hover:bg-fuchsia-700/25' onClick={() => changeTheme({StartColorLinear: 'rgba(112,254,255,1)', EndColorLinear: 'rgba(80,80,255,1)'})}>
                            ...
                            <div className='flex justify-start gap-4 items-center font-medium py-1 px-3 rounded-md text-white hover:bg-fuchsia-700/25' onClick={() => changeTheme({StartColorLinear: 'rgba(247,255,60,1)', EndColorLinear: 'rgba(250,74,255,1)'})}>
                            ...
                            <div className='flex justify-start gap-4 items-center font-medium py-1 px-3 rounded-md text-white hover:bg-fuchsia-700/25' onClick={() => changeTheme({StartColorLinear: 'rgba(145,0,255,1)', EndColorLinear: 'rgba(0,255,149,1)'})}>
                            ...
                            <div className='flex justify-start gap-4 items-center font-medium py-1 px-3 rounded-md text-white hover:bg-fuchsia-700/25' onClick={() => changeTheme({StartColorLinear: 'rgba(150,150,150,1)', EndColorLinear: 'rgba(0,0,0,1)'})}>
                ...
                <div ref={buttonLanguageRef} onClick={toggleShowLanguage} className='relative flex w-9 h-5 cursor-pointer'>
                    ...
                    <div ref={languageRef} style={{background: `linear-gradient(0deg, ${themeColors.StartColorLinear} 0%, ${themeColors.EndColorLinear} 100%)`}} className={`absolute top-7 right-1 w-52 py-4 px-5 bg-orange-500 rounded-tl-2xl rounded-bl-2xl rounded-br-2xl z-[1000] ${showLanguage ? 'block' : 'hidden'}`}>
                        <div onClick={() => changeLanguage('vi')} className='flex justify-start items-center gap-3 font-semibold text-white py-1 px-2 rounded-sm cursor-pointer hover:bg-fuchsia-700/25 mb-1'>
                            <img className='w-8' src={VietNam} alt="" /> Tiếng việt
                            {i18n.language == 'vi' ? <span className="text-white text-h3"><i className='bx bx-check-double'></i></span> : ''}
                        </div>
                        <div onClick={() => changeLanguage('en')} className='flex justify-start items-center gap-3 font-semibold text-white py-1 px-2 rounded-sm cursor-pointer hover:bg-fuchsia-700/25 '>
                            <img className='w-8' src={England} alt="" /> English
                            {i18n.language == 'en' ? <span className="text-white text-h3"><i className='bx bx-check-double'></i></span> : ''}
                        </div>
                    </div>
                </div>
                ...
                <div className='relative' ref={buttonServiceRef} onClick={toggleShowUserService}> 
                    ...
                    <div ref={serviceRef} className={`absolute z-[1000] w-40 top-8 right-0 py-1 px-3 rounded-tl-xl rounded-br-xl ${showUserService ? 'block' : 'hidden'}`} style={{background: `linear-gradient(0deg, ${themeColors.StartColorLinear} 0%, ${themeColors.EndColorLinear} 100%)`}}>
                        <ul>
                            <li className='flex justify-start items-center gap-3 py-1 px-3 rounded-md text-white hover:bg-violet-700/25' onClick={() => Logout()}>
