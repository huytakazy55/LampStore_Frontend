...
const NavbarPrimary = () =>
{
  ...
  {
    return (
      <div className='bg-secondary-400 w-full h-12'>
  ...
  return (
    <div className='bg-secondary-400 dark:bg-gray-900 dark:border-b dark:border-primary-500/30 w-full h-12'>
      <nav className='relative xl:mx-auto xl:max-w-[1440px] flex justify-between items-center h-full px-4 xl:px-0'>
        <ul className='flex justify-start h-full relative overflow-x-auto overflow-y-hidden scrollbar-hide w-full'>
          {categories.map((category) => (
            ...
            >
              <a className='text-black dark:text-primary-400 font-medium text-xs md:text-sm whitespace-nowrap' href={`/categories/${category.id}`}
